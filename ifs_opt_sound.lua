...
function ifs_opt_sound_fnBuildScreen(this)
    ...
    if(gPlatformStr ~= "PC") then
		...
		if((gPlatformStr == "PS2") and (gLangStr == "german")) then
			ifs_opt_sound_vbutton_layout.font = "meu_myriadpro_small"
		end
...
-- 		end
    ...
    if (gPlatformStr == "PC") then
        this.logoInfos["envmorphing"] = NewIFText { y = 0,  font = "meu_myriadpro_small", textw = 300, texth = 50, halign = "left", valign = "vcenter", string = "ifs.soundopt.eax.envmorphing" }
        this.logoInfos["occulsion"]   = NewIFText { y = 30, font = "meu_myriadpro_small", textw = 300, texth = 50, halign = "left", valign = "vcenter", string = "ifs.soundopt.eax.occlusion" }
        this.logoInfos["reverb"]      = NewIFText { y = 60, font = "meu_myriadpro_small", textw = 300, texth = 50, halign = "left", valign = "vcenter", string = "ifs.soundopt.eax.reverb" }
        this.logoInfos["envpanning"]  = NewIFText { y = 90, font = "meu_myriadpro_small", textw = 300, texth = 50, halign = "left", valign = "vcenter", string = "ifs.soundopt.eax.envpanning" }
    end
