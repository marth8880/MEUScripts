...
if(gPlatformStr == "PS2") then
  ...
  gMenuButtonFont = "meu_myriadpro_large" -- font used on all menu screens that are vertical buttons
	gPopupTextFont = "meu_myriadpro_small"
	gPopupTinyTextFont = "meu_myriadpro_tiny"
	gPopupButtonFont = "meu_myriadpro_small"
	gListboxItemFont = "meu_myriadpro_large" -- font used in options listboxes.
...
elseif (gPlatformStr == "PC") then
  ...
  gTitleTextColor = { 209, 209, 209} -- of listbox titles, buttonlist titles yellow
...
function NewIFText(Template)
	...
	temp.font = temp.font or "meu_myriadpro_small"
