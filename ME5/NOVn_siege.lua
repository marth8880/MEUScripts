...
manager = MapManager:New{
	...
	heroSupportCPs = {
				...
				{"team2_permacp", "CP5SpawnPathCon"},
				{"team1_permacp", "CP6SpawnPathCon"},
...
function ScriptPostLoad()
    ...
    conquest = ObjectiveConquest:New{teamATT = ATT, teamDEF = DEF, 
                                     textATT = "game.modes.siege", textDEF = "game.modes.siege2", 
...
function ScriptInit()
	...
	ReadDataFile("..\\..\\addon\\ME5\\data\\_LVL_PC\\ME5\\NOV.lvl", "NOV_Siege")
    ...
    -- Camera Stats
	AddCameraShot(0.965726, -0.029626, -0.257745, -0.007907, -61.492352, 27.823177, 33.878075);
	AddCameraShot(0.865460, -0.013421, -0.500737, -0.007765, -24.266605, 9.992568, -54.370735);
