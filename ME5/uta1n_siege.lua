...
function SSVxGTH_PostLoad()
	if not ScriptCB_InMultiplayer() then
		...
		elseif ME5_AIHeroes == 1 then
			...
			herosupport:AddSpawnCP("team1_permacp","con_cp1spawn")
			herosupport:AddSpawnCP("con_cp1a","con_cp1aspawn")
			herosupport:AddSpawnCP("con_cp2","con_cp2spawn")
			herosupport:AddSpawnCP("team2_permacp","con_cp5spawn")
...
function ScriptPostLoad()
	...
	SetProperty("team1_permacp", "AllyPath", "con_cp1spawn")
	SetProperty("con_CP1a", "AllyPath", "con_cp1aspawn")
	SetProperty("CON_CP2", "AllyPath", "con_cp2spawn")
	SetProperty("team2_permacp", "AllyPath", "con_cp5spawn")
	...
	SetReinforcementCount(REP, 275)
	SetReinforcementCount(CIS, 275)
...
function ScriptInit()
    ...
    ReadDataFile("..\\..\\addon\\ME5\\data\\_LVL_PC\\ME5\\uta1.lvl", "uta1_siege")
